...
/*Scenario:Offnet call to tollfree(rate feature is enabled and trunk is disabled)
...
def limitResponse = CustomKeywords.'cdr_Utility.API_CDR_setup_keyword.disable_account_limits'(GlobalVariable.gateway_call_account_details1.get("account_id"))
