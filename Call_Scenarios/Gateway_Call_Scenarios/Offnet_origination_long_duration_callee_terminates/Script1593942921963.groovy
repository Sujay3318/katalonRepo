...
/*Scenario:Offnet origination long duration gateway call,user1 calls to user2,user2 receive the call and after 900 sec user2 hangs up the call
 *account1 user1=caller
 *account2 user2=callee
 *user1 calls to user2
 *user2 receive the call
 *user2 hangs up the call
 */
